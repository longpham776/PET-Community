...
if ($m =='')
{
    header('location:thuonghieu.php');exit;
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div id="main-content"> <!-- Main Content Section with everything -->
		...
		?>
			...
			<form action="update_th.php" method='post'>
				Mã sản phẩm: <input type="text" name="math" readonly value='<?php echo $data1->math ?>'> <br><br>
				Tên sản phẩm: <input type="text" name="tenth" value='<?php echo $data1->tenth ?>'> <br><br>
