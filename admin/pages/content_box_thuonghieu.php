<?php 
$sql='select * from thuonghieu where xoa=0';//2 
...
?>
<form width="100%" action="store_th.php" method="post" enctype="multipart/form-data"><br>
    &ensp;Mã thương hiệu: <input type="text" readonly name="math"> <br><br>
    &ensp;Tên thương hiệu: <input type="text" name="tenth"> <br><br>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $th)
                {
                    ...
                    <td><h3><?php echo $th->math ?><h3></td>
                    <td><h3><?php echo $th->tenth ?></h3></td>
                    <td>
                        <!-- Icons -->
                            <a href="edit_th.php?math=<?php echo $th->math ?>" 
                            onclick="return confirm('Bạn muốn xóa thương hiệu có tên là <?php echo $th->tenth ?> ?')"
                            title="Edit"><img src="resources/images/icons/pencil.png" alt="edit" /></a> 
                            <a href="delete_th.php?math=<?php echo $th->math ?>" 
                            onclick="return confirm('Bạn muốn xóa thương hiệu có tên là <?php echo $th->tenth ?> ?')"
