<?php 
$sql='select * from quantri where xoa=1';//2 
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $tk)
                {
                    ...
                    <td>
                        <!-- Icons -->
                        <a href="khoiphuc_tk.php?username=<?php echo $tk->username ?>" 
                            onclick="return confirm('Bạn muốn khôi phục user có tên là <?php echo $tk->username ?> ?')"
                            title="Restore"><img src="resources/images/icons/hammer_screwdriver.png" alt="Restore" /></a> 
                            <a href="delete_rtk.php?username=<?php echo $tk->username ?>" 
                            onclick="return confirm('Bạn muốn xóa user có tên là <?php echo $tk->username ?> ?')"
