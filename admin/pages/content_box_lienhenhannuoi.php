...
$sql="select * from lienhenhannuoi where mapet=? and xoa=0";//2 
$a =[$m];
...
<form width="100%" action="store_lhnn.php" method="post" enctype="multipart/form-data"><br>
    &ensp;Họ tên: <input type="text" name="hoten"> <br><br>
    &ensp;Điện thoại: <input type="number" name="dienthoai"> <br><br>
    &ensp;Email: <input type="text" name="email"> <br><br>
    &ensp;Facebook: <input type="text" name="facebook"> <br><br>
    <input type="text" hidden name="mapet" value="<?php echo $m ?>"> <br><br>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $lh)
                {
                    ...
                    <td><h3><?php echo $lh->stt ?><h3></td>
                    <td><h3><?php echo $lh->hoten ?></h3></td>
                    <td><h3><?php echo $lh->dienthoai ?></h3></td>
                    <td><h3><?php echo $lh->email ?></h3></td>
                    <td><h3><?php echo $lh->facebook ?></h3></td>
                    <td><img src='./resources/images/<?php echo $lh->hinh ?>' style="width:100px;height:100px;"> </td>
                    <td>
                        <!-- Icons -->
                            <a href="edit_lhnn.php?mapet=<?php echo $lh->mapet ?>&stt=<?php echo $lh->stt ?>" 
                            onclick="return confirm('Bạn muốn sửa thông tin liên hệ có tên là <?php echo $lh->hoten ?> ?')"
                            title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
                            <a href="delete_lhnn.php?mapet=<?php echo $lh->mapet ?>&stt=<?php echo $lh->stt ?>" 
                            onclick="return confirm('Bạn muốn xóa thông tin liên hệ có tên là <?php echo $lh->hoten ?> ?')"
