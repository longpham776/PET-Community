<?php 
$sql='select * from loaipet where xoa=1';//2 
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $pet)
                {
                    ...
                    <td>
                        <!-- Icons -->
                        <a href="khoiphuc_loaipet.php?maloai=<?php echo $pet->maloai ?>" 
                            onclick="return confirm('Bạn muốn khôi phục loại có tên là <?php echo $pet->tenloai ?> ?')"
                            title="Restore"><img src="resources/images/icons/hammer_screwdriver.png" alt="Restore" /></a> 
                            <a href="delete_rloaipet.php?maloai=<?php echo $pet->maloai ?>" 
                            onclick="return confirm('Bạn muốn xóa loại có tên là <?php echo $pet->tenloai ?> ?')"
