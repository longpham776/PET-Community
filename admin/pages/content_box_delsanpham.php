<?php 
$sql='select * from sanpham where xoa=1';//2 
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $sp)
                {
                    ...
                    <td>
                        <!-- Icons -->
                            <a href="khoiphuc_sp.php?masp=<?php echo $sp->masp ?>" 
                            onclick="return confirm('Bạn muốn khôi phục sản phẩm có tên là <?php echo $sp->tensp ?> ?')"
                            title="Restore"><img src="resources/images/icons/hammer_screwdriver.png" alt="Restore" /></a> 
                            <a href="delete_rpet.php?masp=<?php echo $sp->masp ?>" 
                            onclick="return confirm('Bạn muốn xóa sản phẩm có tên là <?php echo $sp->tensp ?> ?')"
