<?php 
$sql='select * from thucung where xoa=0';//2 
...
$sql='select * from loaipet';
$objStatement= $objPDO->prepare($sql);
$objStatement->execute();
$dataLoai = $objStatement->fetchAll(PDO::FETCH_OBJ);
?>
<form width="100%" action="store.php" method="post" enctype="multipart/form-data"><br>
    &ensp;Mã pet: <input type="text" readonly name="mapet"> <br><br>
    &ensp;Tên pet: <input type="text" name="tenpet"> <br><br>
    ...
    &ensp;Loại thú cưng: <select name="maloai" id="">
    <?php 
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $pet)
                {
                    ...
                    <td>
                        <!-- Icons -->
                            <a href="edit.php?mapet=<?php echo $pet->mapet ?>" 
                            onclick="return confirm('Bạn muốn sửa thú cưng có tên là <?php echo $pet->tenpet ?> ?')"
                            title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
                            <a href="delete.php?mapet=<?php echo $pet->mapet ?>" 
                            ...
                            <a href="lienhenhannuoi.php?mapet=<?php echo $pet->mapet ?>" 
                            title="Danh sách liên hệ nhận nuôi"><img src="resources/images/icons/information.png" alt="Danh sách liên hệ nhận nuôi" /></a> 
                    </td>
                </tr>
                    <?php
                }
