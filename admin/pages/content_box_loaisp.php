<?php 
$sql='select * from loaisp where xoa=0';//2 
...
?>
<form width="100%" action="store_lsp.php" method="post" enctype="multipart/form-data"><br>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $lsp)
                {
                    ...
                    <td><h3><?php echo $lsp->maloai ?><h3></td>
                    <td><h3><?php echo $lsp->tenloai ?></h3></td>
                    <td>
                        <!-- Icons -->
                            <a href="edit_lsp.php?maloai=<?php echo $lsp->maloai ?>" 
                            onclick="return confirm('Bạn muốn xóa loại sản phẩm có tên là <?php echo $lsp->tenloai ?> ?')"
                            title="Edit"><img src="resources/images/icons/pencil.png" alt="edit" /></a> 
                            <a href="delete_lsp.php?maloai=<?php echo $lsp->maloai ?>" 
                            onclick="return confirm('Bạn muốn xóa loại sản phẩm có tên là <?php echo $lsp->tenloai ?> ?')"
