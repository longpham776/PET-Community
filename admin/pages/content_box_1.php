<?php 
$sql='select * from bengoantrongtuan where xoa=0';//2 
...
?>
<form width="100%" action="store_1.php" method="post" enctype="multipart/form-data"><br>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $pet)
                {
                    ...
                    <td>
                        <!-- Icons -->
                            <a href="edit_1.php?mapet=<?php echo $pet->mapet ?>" 
                            ...
                            <a href="delete_1.php?mapet=<?php echo $pet->mapet ?>" 
