<?php 
$sql='select * from spnoibat where xoa=0';//2 
...
?>
<form width="100%" action="store_3.php" method="post" enctype="multipart/form-data"><br>
    &ensp;Mã sản phẩm: <input type="text" name="masp"> <br><br>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $sp)
                {
                    ...
                    <td>
                        <!-- Icons -->
                            <a href="edit_3.php?masp=<?php echo $sp->masp ?>" 
                            ...
                            <a href="delete_3.php?masp=<?php echo $sp->masp ?>" 
