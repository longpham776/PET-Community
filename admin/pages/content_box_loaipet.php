<?php 
$sql='select * from loaipet where xoa=0';//2 
...
?>
<form width="100%" action="store_loaipet.php" method="post" enctype="multipart/form-data"><br>
    &ensp;Mã loại: <input type="text" readonly name="maloai"> <br><br>
    &ensp;Tên loại: <input type="text" name="tenloai"> <br><br>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach($data as $pet)
                {
                    ...
                    <td><h3><?php echo $pet->maloai ?><h3></td>
                    <td><h3><?php echo $pet->tenloai ?></h3></td>
                    <td>
                        <!-- Icons -->
                            <a href="edit_loaipet.php?maloai=<?php echo $pet->maloai ?>" 
                            onclick="return confirm('Bạn muốn xóa loại thú cưng có tên là <?php echo $pet->tenloai ?> ?')"
                            title="Edit"><img src="resources/images/icons/pencil.png" alt="edit" /></a> 
                            <a href="delete_loaipet.php?maloai=<?php echo $pet->maloai ?>" 
                            onclick="return confirm('Bạn muốn xóa loại thú cưng có tên là <?php echo $pet->tenloai ?> ?')"
